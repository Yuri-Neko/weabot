...
const start = async () => {
  ...
  `);
      ...
      case "tobase64":
        ...
        const tobase64 = await axios.get(
          `https://mfarels.my.id/api/base64enc?text=${q}`
        );
      ...
      case "base64":
        ...
        const base64 = await axios.get(
          `https://mfarels.my.id/api/base64dec?text=${q}`
        );
      ...
      case "gtwiki":
        ...
        try {
          const wikig = await axios.get(
            `https://violet-narwhal-cap.cyclic.app/api/gtwiki?keyword=${q}`
          );
      ...
      case "shortlink":
        ...
        const urlqr = await axios.get(
          `https://mfarels.my.id/api/qrcodev2?text=${shortUrl}`
        );
        sock.sendMessage(from, {
      ...
      case "s":
        ...
        if (isImage || isQuotedImage) {
          ...
          ffmpeg(stream)
            ...
            .on("end", async () => {
              sock
                .sendMessage(from, { sticker: { url: `./${sender}.webp` } })
                .then(() => {
